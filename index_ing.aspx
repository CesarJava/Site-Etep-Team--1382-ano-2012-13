<%@ Page Language="C#" MasterPageFile="~/LayoutPage_ing.master" AutoEventWireup="true" CodeFile="index_ing.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div id="CaixaChamadaTop">
                                ...
                                <div id="ConteudoChamada"> 
                                    <span class="cabecalhoN1">NEWS</span><br />
                                    <br></br>
                                    <form action="NoticiaCompleta_ing.aspx" id="postnoticia" name="postnoticia"  method="post">

                                     <%= this.exibir_noticia("INGLES")%>
                            ...
                            <div id="CaixaChamadaBottom">
                                ...
                                <div id="ConteudoChamada2">
                                    <span class="cabecalhoN1">PROGRESS</span><br />
                                    <br></br>
                                    <form action="ProgressoCompleto_ing.aspx" id="postprogresso" name="postprogresso"  method="post">

                                       <%= this.exibir_progresso("INGLES")%>
