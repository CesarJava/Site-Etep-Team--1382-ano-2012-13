<%@ Page Language="C#" MasterPageFile="~/LayoutPage.master" AutoEventWireup="true" CodeFile="DescricaoTemp.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                            ...
                            <div style=" float:  left; margin-left: 50px; width: 650px; height: auto;" >
                                ...
                                <%= this.SelecionarConteudo_id("PROTUGUES")%>
                            </div>
                            ...
                            <div style=" float:  left;  margin-left: 50px; width: 650px; height: auto;">
                                ...
                                <div style=" float:  left; width: 325px; height: auto;" >
                                    ...
                                    <%= this.SelecionarArquivo_id("PORTUGUES")%>
                                </div>
                                ...
                                <div style="width: 325px;  height: auto;  font-size: 20px; float: left;color: #000">
                                    <div style=" float:  left;   margin-left: 50px; width: 650px; height: 30px;" ><br></br></div>
                                    <%= this.Selecionar_Conteudo_robo("PROTUGUES")%>
                                </div>
                            </div>
