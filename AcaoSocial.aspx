<%@ Page Language="C#" MasterPageFile="~/LayoutPage.master" AutoEventWireup="true" CodeFile="AcaoSocial.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
                         ...
                         <%
                            ...
                            <div style="width: 750px; height: auto ; font-size: 20px; color: #000">
                                ...
                                <div style="float: left; margin-left: 50px; height: auto; width: 650px;">
                                    ...
                                    <span >          <%= this.Selecionar( "PORTUGUES")%>
                                    </span><br />
