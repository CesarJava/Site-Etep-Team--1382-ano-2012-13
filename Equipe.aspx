<%@ Page Language="C#" MasterPageFile="~/LayoutPage.master" AutoEventWireup="true" CodeFile="Equipe.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
                            ...
                            <div id="CaixaChamadaBottom">
                                ...
                                <div  id="ConteudoChamada2">
                                    <div style="width: 750px; font-size: 20px; color: #000">
                                        ...
                                        <br></br>
                                        <br></br>
                                        <div style="width: 520px; padding-left: 60px; font-size: 20px; color: #000"> <%= this.Selecionar("PORTUGUES")%></div>
                                    </div>
                                </div>
                            </div>
