<%@ Page Language="C#" MasterPageFile="~/LayoutPage.master" AutoEventWireup="true" CodeFile="NoticiaCompleta.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                            ...
                            <%
                                        ...
                                        variavel =  Request.Params.Get("id_noticia");
                            ...
                            <div style="width: 720px; height: auto; padding-left: 30px; float: left; color: #000; font-size: 17px;  ">
                                ...
                                <%= this.Selecionar_Conteudo("PORTUGUES")%>
